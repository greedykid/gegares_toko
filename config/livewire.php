...
return [
    ...
    */
    ...
    'payload' => [
        ...
        /*
         | Dinaikkan dari 20 (bawaan Livewire).
         |
         | Halaman /produk memasang satu komponen ToggleWishlist pada setiap
         | kartu, dan "Muat Lebih Banyak" menambah 12 kartu tiap kali ditekan.
         | Semuanya mendengarkan `wishlist-updated`, jadi satu klik hati
         | mengirim seluruh komponen itu dalam satu permintaan — dua kali muat
         | saja sudah melewati 20 dan berakhir 500.
         |
         | Fan-out-nya sendiri sudah dipangkas di ToggleWishlist::toggle()
         | lewat dispatch bertarget. Angka ini jaring pengaman untuk jalur yang
         | memang masih perlu menyiarkan ke semua kartu, yaitu penghapusan
         | lewat drawer wishlist.
         */
        'max_components' => 60,      // Maximum components per batch request
    ],
];
