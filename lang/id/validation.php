...
return [
    ...
    // "surel" is the formal term; a storefront's customers say "email".
    ...
    'attributes'             => [
        ...
        /*
        | Gegares' own fields. laravel-lang ships the generic ones above, but
        | nothing knows what `address_id` or `shipping_courier` mean here — and
        | without these the messages fall back to the raw column name
        | ("Address id wajib diisi"), which is worse than English.
        |
        | NOTE: `php artisan lang:update` rewrites this file from the package.
        | Re-add this block if that is ever run.
        */
        ...
        'usage_limit_per_user'     => 'batas pemakaian per pengguna',
        ...
        'hero_subtitle'            => 'subjudul utama',
        'hero_badge'               => 'label sorotan',
        'about_title'              => 'judul halaman tentang',
        'about_subtitle'           => 'subjudul halaman tentang',
        'about_story_title'        => 'judul cerita',
        'about_story_content'      => 'isi cerita',
        'about_vision'             => 'visi',
        'cta_title'                => 'judul ajakan',
        'cta_subtitle'             => 'subjudul ajakan',
    ],
];
