...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 space-y-16">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 class="text-4xl sm:text-5xl font-black text-slate-900 dark:text-slate-100 tracking-tight uppercase">
            Ada <span class="text-primary-600">Pertanyaan?</span>
        </h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div class="lg:col-span-7 bg-slate-50 dark:bg-slate-900/60 rounded-[2.5rem] border-2 border-slate-100 dark:border-slate-800 p-8 lg:p-12 transition-all duration-300"
             x-data="{ 
                name: '', 
            ...
            <form @submit.prevent="sendToWhatsapp" class="space-y-6">
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full py-4.5 bg-[#25D366] hover:bg-[#1EBE5D] text-white font-black rounded-2xl active:scale-[0.98] transition-all duration-300 flex items-center justify-center gap-3">
        ...
        <div class="lg:col-span-5 space-y-6">
            {{-- Email Card --}}
            <div class="p-8 bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm hover:border-primary-500/60 hover:-translate-y-1 transition-all duration-300 flex items-start gap-6 group">
                <div class="w-14 h-14 shrink-0 bg-primary-50 dark:bg-primary-950/40 rounded-2xl flex items-center justify-center border border-primary-100/30 dark:border-primary-900/20 group-hover:bg-primary-600 group-hover:text-white transition-colors duration-300">
            ...
            {{-- Phone Card --}}
            <div class="p-8 bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm hover:border-accent-500 hover:-translate-y-1 transition-all duration-300 flex items-start gap-6 group">
                <div class="w-14 h-14 shrink-0 bg-accent-50 dark:bg-accent-950/40 rounded-2xl flex items-center justify-center border border-accent-100/30 dark:border-accent-900/20 group-hover:bg-accent-600 group-hover:text-white transition-colors duration-300">
            ...
            {{-- Address Card --}}
            <div class="p-8 bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm hover:border-emerald-500 hover:-translate-y-1 transition-all duration-300 flex items-start gap-6 group">
                <div class="w-14 h-14 shrink-0 bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl flex items-center justify-center border border-emerald-100/30 dark:border-emerald-900/20 group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-300">
            ...
            {{-- Hours Card --}}
            <div class="p-8 bg-white dark:bg-slate-900 rounded-[2rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm hover:border-amber-500 hover:-translate-y-1 transition-all duration-300 flex items-start gap-6 group">
                <div class="w-14 h-14 shrink-0 bg-amber-50 dark:bg-amber-950/40 rounded-2xl flex items-center justify-center border border-amber-100/30 dark:border-amber-900/20 group-hover:bg-amber-600 group-hover:text-white transition-colors duration-300">
