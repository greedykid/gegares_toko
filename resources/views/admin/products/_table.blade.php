            ...
            <table class="w-full admin-table">
                <thead>
                    <tr class="border-b border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-800/40">
                        ...
                        <x-admin.sort-header column="name" :sort="$sort" :dir="$dir">Produk</x-admin.sort-header>
                        <x-admin.sort-header column="description" :sort="$sort" :dir="$dir">Deskripsi</x-admin.sort-header>
                        <x-admin.sort-header column="category_id" :sort="$sort" :dir="$dir">Kategori</x-admin.sort-header>
                        <x-admin.sort-header column="price" :sort="$sort" :dir="$dir" align="right">Harga</x-admin.sort-header>
                        <x-admin.sort-header column="stock" :sort="$sort" :dir="$dir" align="center">Stok</x-admin.sort-header>
                        <x-admin.sort-header column="is_featured" :sort="$sort" :dir="$dir" align="center">Unggulan</x-admin.sort-header>
