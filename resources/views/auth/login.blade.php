...
@section('content')
    ...
    <div>
        ...
        <form id="login-form" method="POST" action="{{ route('login') }}" class="space-y-5">
            ...
            <button type="submit"
                class="w-full py-3 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-600/10 active:scale-98 transition-all duration-200">
                Masuk
            </button>
