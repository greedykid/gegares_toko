...
<div>
    ...
    <form id="register-form" method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div class="pt-4">
            <button type="submit" class="w-full py-3.5 bg-primary-600 text-white font-bold rounded-xl hover:bg-primary-700 hover:shadow-lg hover:shadow-primary-600/10 active:scale-98 transition-all duration-200 mt-2">
                Daftar
            </button>
