        ...
        <div x-show="open" style="display: none;" x-collapse class="bg-slate-50/50 dark:bg-slate-900/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800 mt-2">
            <form wire:submit.prevent="submit" class="space-y-4">
                ...
                <div class="flex gap-2 justify-end pt-1">
                    ...
                    <button type="submit" wire:loading.attr="disabled" class="px-5 py-2 bg-primary-600 text-white text-sm font-bold rounded-xl shadow-sm hover:bg-primary-700 focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all disabled:opacity-50">
