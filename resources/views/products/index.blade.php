    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <aside :class="filterOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'" 
            ...
            <form id="filter-form" method="GET" action="{{ route('products.index') }}" 
                ...
                <div class="flex items-center justify-between lg:hidden pb-4 border-b border-slate-100 dark:border-slate-800 mb-2">
                    ...
                    <button type="button" @click="filterOpen = false" class="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 transition-colors">
        ...
        <div class="flex-1">
            @if($products->count())
                ...
                <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 shadow-sm rounded-2xl p-4 mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 transition-colors duration-300">
                    <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <span>Menampilkan <strong class="px-2 py-0.5 rounded-lg bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-100/80 dark:border-slate-800 font-bold">{{ $products->firstItem() ?? 0 }}-{{ $products->lastItem() ?? 0 }}</strong> dari <strong class="px-2 py-0.5 rounded-lg bg-primary-50 dark:bg-primary-950/30 text-primary-700 dark:text-primary-400 border border-primary-100/30 font-bold">{{ $products->total() }}</strong> produk</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                        ...
                        <div x-data="{ 
                            ...
                            <div x-show="open" 
                                ...
                                <button type="button" @click="selectedValue = 'price_low'; selectedLabel = 'Harga Terendah'; open = false; document.getElementById('filter-sort-input').value = 'price_low'; document.getElementById('filter-form').submit();"
                                        class="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                                        :class="selectedValue === 'price_low' ? 'bg-slate-50 dark:bg-slate-800/50 font-bold text-primary-600 dark:text-primary-400' : ''">Harga Terendah</button>
                                <button type="button" @click="selectedValue = 'price_high'; selectedLabel = 'Harga Tertinggi'; open = false; document.getElementById('filter-sort-input').value = 'price_high'; document.getElementById('filter-form').submit();"
                                        class="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                                        :class="selectedValue === 'price_high' ? 'bg-slate-50 dark:bg-slate-800/50 font-bold text-primary-600 dark:text-primary-400' : ''">Harga Tertinggi</button>
                                <button type="button" @click="selectedValue = 'popular'; selectedLabel = 'Terpopuler'; open = false; document.getElementById('filter-sort-input').value = 'popular'; document.getElementById('filter-form').submit();"
                                        class="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                                ...
                                <button type="button" @click="selectedValue = 'rating'; selectedLabel = 'Rating Tertinggi'; open = false; document.getElementById('filter-sort-input').value = 'rating'; document.getElementById('filter-form').submit();"
                                        class="w-full text-left px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors"
                                        :class="selectedValue === 'rating' ? 'bg-slate-50 dark:bg-slate-800/50 font-bold text-primary-600 dark:text-primary-400' : ''">Rating Tertinggi</button>
                            </div>
                        </div>
                    </div>
                </div>
